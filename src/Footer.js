...
function Footer() {
    return (
        <div class=" flex content-end fixed sm:fixed inset-x-0 bottom-0 bg-[#73BDAB] overflow-auto">
            <div class="flex items-center sm:flex-row flex-col  overflow-auto">

                <h1 class="px-8 text-black text-lg font-bold">Contact me: </h1>

                <a class=" group flex flex-row hover:bg-[#6F5643] hover:item p-4 h-full"
                ...
                <a class=" group flex flex-row justify-center hover:bg-[#6F5643] hover:item p-4 h-full"
